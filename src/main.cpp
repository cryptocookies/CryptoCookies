...
uint256 hashGenesisBlock("0x00000000ebbe172a3d82789b642bc1510ce0539b1770022beab166f83b145d5f");
...
const string strMessageMagic = "Cookies Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 5000000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 5000000);
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000ebbe172a3d82789b642bc1510ce0539b1770022beab166f83b145d5f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Mtgox BTCUSD 2014-02-08T11:46:09; last:694.91 buy:686.01 sell:694.91";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391859984;
        block.nBits    = 486604799;
        block.nNonce   = 2293077177;
        ...
        assert(block.hashMerkleRoot == uint256("0x929dc2b668e3a8f4efafb70315e593058de4c882bec97cc0e7d6030d12e9c6a1"));
        block.print();
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CookiesMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CookiesMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running CookiesMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CookiesMiner terminated\n");
        throw;
    }
}
